...
export const LIGHT_COLORS = {
  ...
  "--color-decorative-600": "hsl(352deg, 98%, 50%)",
  "--color-decorative-700": "hsl(352deg, 98%, 50%)",
  "--color-decorative-800": "hsl(352deg, 98%, 50%)",
  "--color-decorative-900": "hsl(352deg, 98%, 50%)",
  "--color-gray-0": "white",
...
export const DARK_COLORS = {
  ...
  "--color-primary-100": "hsl(235deg	32%	42%)",
  "--color-primary-300": "hsl(235deg	32%	42%)",
  "--color-primary-500": "hsl(235deg	32%	42%)",
  "--color-primary-700": "hsl(235deg	32%	42%)",
  "--color-primary-900": "hsl(235deg	32%	42%)",
  ...
  "--color-decorative-700": "hsl(50deg 15% 85%)",
...
LIGHT_COLORS["--color-backdrop"] = LIGHT_COLORS["--color-primary-500"];
LIGHT_COLORS["--color-backdrop-highlight"] =
  LIGHT_COLORS["--color-primary-300"];
LIGHT_COLORS["--color-page-background"] = LIGHT_COLORS["--color-primary-100"];
