...
export const LIGHT_COLORS = {
  ...
  '--color-decorative-100': 'hsl(10deg 100% 94%)',
  '--color-decorative-200': 'hsl(10deg 100% 90%)',
  '--color-decorative-300': 'hsl(10deg 100% 85%)',
  '--color-decorative-500': 'hsl(10deg 100% 70%)',
  '--color-decorative-600': 'hsl(10deg 100% 60%)',
  '--color-decorative-700': 'hsl(10deg 100% 50%)',
  '--color-decorative-800': 'hsl(10deg 100% 33%)',
  '--color-decorative-900': 'hsl(10deg 100% 25%)',
  '--color-gray-0': 'white',
